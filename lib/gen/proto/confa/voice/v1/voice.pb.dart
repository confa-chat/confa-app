...
class SendMeta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SendMeta', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
...
class VoiceInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VoiceInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
...
class ReceiveMeta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReceiveMeta', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class VoiceData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VoiceData', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
