...
import 'voice_relay.pb.dart' as $0;

export 'voice_relay.pb.dart';

@$pb.GrpcServiceName('confa.voice.v1.VoiceRelayService')
class VoiceRelayServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$0.WatchChannelResponse> watchChannel($0.WatchChannelRequest request, {$grpc.CallOptions? options,}) {
    return $createStreamingCall(_$watchChannel, $async.Stream.fromIterable([request]), options: options);
  }

    // method descriptors

  static final _$speakToChannel = $grpc.ClientMethod<$0.SpeakToChannelRequest, $0.SpeakToChannelResponse>(
      '/confa.voice.v1.VoiceRelayService/SpeakToChannel',
  ...
  static final _$listenToUser = $grpc.ClientMethod<$0.ListenToUserRequest, $0.ListenToUserResponse>(
      '/confa.voice.v1.VoiceRelayService/ListenToUser',
  ...
  static final _$joinChannel = $grpc.ClientMethod<$0.JoinChannelRequest, $0.JoinChannelResponse>(
      '/confa.voice.v1.VoiceRelayService/JoinChannel',
      ($0.JoinChannelRequest value) => value.writeToBuffer(),
      $0.JoinChannelResponse.fromBuffer);
  static final _$watchChannel = $grpc.ClientMethod<$0.WatchChannelRequest, $0.WatchChannelResponse>(
      '/confa.voice.v1.VoiceRelayService/WatchChannel',
      ($0.WatchChannelRequest value) => value.writeToBuffer(),
      $0.WatchChannelResponse.fromBuffer);
}

@$pb.GrpcServiceName('confa.voice.v1.VoiceRelayService')
abstract class VoiceRelayServiceBase extends $grpc.Service {
  $core.String get $name => 'confa.voice.v1.VoiceRelayService';
  ...
  VoiceRelayServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.WatchChannelRequest, $0.WatchChannelResponse>(
        'WatchChannel',
        watchChannel_Pre,
        false,
        true,
        ($core.List<$core.int> value) => $0.WatchChannelRequest.fromBuffer(value),
        ($0.WatchChannelResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Stream<$0.WatchChannelResponse> watchChannel_Pre($grpc.ServiceCall $call, $async.Future<$0.WatchChannelRequest> $request) async* {
    yield* watchChannel($call, await $request);
  }

  $async.Stream<$0.WatchChannelResponse> watchChannel($grpc.ServiceCall call, $0.WatchChannelRequest request);
