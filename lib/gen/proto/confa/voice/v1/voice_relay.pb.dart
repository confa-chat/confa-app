...
//
// Generated from confa/voice/v1/voice_relay.proto.
...
class JoinChannelRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JoinChannelRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
...
class JoinChannelResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JoinChannelResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
    ..oo(0, [1])
...
class UsersState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UsersState', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
...
class SpeakToChannelRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeakToChannelRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class SpeakToChannelResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeakToChannelResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ListenToUserRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenToUserRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
    ..aOM<$1.VoiceInfo>(1, _omitFieldNames ? '' : 'voiceInfo', subBuilder: $1.VoiceInfo.create)
    ..hasRequiredFields = false
  ;
...
class ListenToUserResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenToUserResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1.VoiceInfo>(1, _omitFieldNames ? '' : 'voiceInfo', subBuilder: $1.VoiceInfo.create)
    ..aOM<$1.VoiceData>(2, _omitFieldNames ? '' : 'voiceData', subBuilder: $1.VoiceData.create)
    ..hasRequiredFields = false
...
enum WatchChannelRequest_Request {
  requestSingle, 
  notSet
}

class WatchChannelRequest extends $pb.GeneratedMessage {
  factory WatchChannelRequest({
    WatchChannelRequestSingle? requestSingle,
  }) {
    final result = create();
    if (requestSingle != null) result.requestSingle = requestSingle;
    return result;
  }

  WatchChannelRequest._();

  factory WatchChannelRequest.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory WatchChannelRequest.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static const $core.Map<$core.int, WatchChannelRequest_Request> _WatchChannelRequest_RequestByTag = {
    1 : WatchChannelRequest_Request.requestSingle,
    0 : WatchChannelRequest_Request.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WatchChannelRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<WatchChannelRequestSingle>(1, _omitFieldNames ? '' : 'requestSingle', subBuilder: WatchChannelRequestSingle.create)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WatchChannelRequest clone() => WatchChannelRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WatchChannelRequest copyWith(void Function(WatchChannelRequest) updates) => super.copyWith((message) => updates(message as WatchChannelRequest)) as WatchChannelRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static WatchChannelRequest create() => WatchChannelRequest._();
  @$core.override
  WatchChannelRequest createEmptyInstance() => create();
  static $pb.PbList<WatchChannelRequest> createRepeated() => $pb.PbList<WatchChannelRequest>();
  @$core.pragma('dart2js:noInline')
  static WatchChannelRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WatchChannelRequest>(create);
  static WatchChannelRequest? _defaultInstance;

  WatchChannelRequest_Request whichRequest() => _WatchChannelRequest_RequestByTag[$_whichOneof(0)]!;
  void clearRequest() => $_clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  WatchChannelRequestSingle get requestSingle => $_getN(0);
  @$pb.TagNumber(1)
  set requestSingle(WatchChannelRequestSingle value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasRequestSingle() => $_has(0);
  @$pb.TagNumber(1)
  void clearRequestSingle() => $_clearField(1);
  @$pb.TagNumber(1)
  WatchChannelRequestSingle ensureRequestSingle() => $_ensure(0);
}

class WatchChannelRequestSingle extends $pb.GeneratedMessage {
  factory WatchChannelRequestSingle({
    $core.String? serverId,
    $core.String? channelId,
  }) {
    final result = create();
  ...
  WatchChannelRequestSingle._();

  factory WatchChannelRequestSingle.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory WatchChannelRequestSingle.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WatchChannelRequestSingle', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'serverId')
    ..aOS(2, _omitFieldNames ? '' : 'channelId')
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WatchChannelRequestSingle clone() => WatchChannelRequestSingle()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WatchChannelRequestSingle copyWith(void Function(WatchChannelRequestSingle) updates) => super.copyWith((message) => updates(message as WatchChannelRequestSingle)) as WatchChannelRequestSingle;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static WatchChannelRequestSingle create() => WatchChannelRequestSingle._();
  @$core.override
  WatchChannelRequestSingle createEmptyInstance() => create();
  static $pb.PbList<WatchChannelRequestSingle> createRepeated() => $pb.PbList<WatchChannelRequestSingle>();
  @$core.pragma('dart2js:noInline')
  static WatchChannelRequestSingle getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WatchChannelRequestSingle>(create);
  static WatchChannelRequestSingle? _defaultInstance;
...
class WatchChannelResponse extends $pb.GeneratedMessage {
  factory WatchChannelResponse({
    $core.String? serverId,
    $core.String? channelId,
    UsersState? usersState,
  }) {
  ...
  WatchChannelResponse._();

  factory WatchChannelResponse.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory WatchChannelResponse.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WatchChannelResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'confa.voice.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'serverId')
    ..aOS(2, _omitFieldNames ? '' : 'channelId')
    ..aOM<UsersState>(3, _omitFieldNames ? '' : 'usersState', subBuilder: UsersState.create)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WatchChannelResponse clone() => WatchChannelResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WatchChannelResponse copyWith(void Function(WatchChannelResponse) updates) => super.copyWith((message) => updates(message as WatchChannelResponse)) as WatchChannelResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static WatchChannelResponse create() => WatchChannelResponse._();
  @$core.override
  WatchChannelResponse createEmptyInstance() => create();
  static $pb.PbList<WatchChannelResponse> createRepeated() => $pb.PbList<WatchChannelResponse>();
  @$core.pragma('dart2js:noInline')
  static WatchChannelResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WatchChannelResponse>(create);
  static WatchChannelResponse? _defaultInstance;
  ...
  @$pb.TagNumber(3)
  UsersState get usersState => $_getN(2);
  @$pb.TagNumber(3)
  set usersState(UsersState value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasUsersState() => $_has(2);
  @$pb.TagNumber(3)
  void clearUsersState() => $_clearField(3);
  @$pb.TagNumber(3)
  UsersState ensureUsersState() => $_ensure(2);
}
