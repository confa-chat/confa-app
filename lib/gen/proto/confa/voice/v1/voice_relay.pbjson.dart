...
const JoinChannelResponse$json = {
  ...
  '2': [
    {'1': 'users_state', '3': 1, '4': 1, '5': 11, '6': '.confa.voice.v1.UsersState', '9': 0, '10': 'usersState'},
  ],
  '8': [
    {'1': 'state'},
  ],
...
final $typed_data.Uint8List joinChannelResponseDescriptor = $convert.base64Decode(
    'ChNKb2luQ2hhbm5lbFJlc3BvbnNlEj0KC3VzZXJzX3N0YXRlGAEgASgLMhouY29uZmEudm9pY2'
...
const SpeakToChannelRequest$json = {
  ...
  '2': [
    {'1': 'voice_info', '3': 1, '4': 1, '5': 11, '6': '.confa.voice.v1.VoiceInfo', '9': 0, '10': 'voiceInfo'},
    {'1': 'voice_data', '3': 2, '4': 1, '5': 11, '6': '.confa.voice.v1.VoiceData', '9': 0, '10': 'voiceData'},
  ],
  '8': [
    {'1': 'request'},
  ],
...
final $typed_data.Uint8List speakToChannelRequestDescriptor = $convert.base64Decode(
    'ChVTcGVha1RvQ2hhbm5lbFJlcXVlc3QSOgoKdm9pY2VfaW5mbxgBIAEoCzIZLmNvbmZhLnZvaW'
    'NlLnYxLlZvaWNlSW5mb0gAUgl2b2ljZUluZm8SOgoKdm9pY2VfZGF0YRgCIAEoCzIZLmNvbmZh'
...
const ListenToUserRequest$json = {
  ...
  '2': [
    {'1': 'voice_info', '3': 1, '4': 1, '5': 11, '6': '.confa.voice.v1.VoiceInfo', '10': 'voiceInfo'},
  ],
};
...
final $typed_data.Uint8List listenToUserRequestDescriptor = $convert.base64Decode(
    'ChNMaXN0ZW5Ub1VzZXJSZXF1ZXN0EjgKCnZvaWNlX2luZm8YASABKAsyGS5jb25mYS52b2ljZS'
...
final $typed_data.Uint8List listenToUserResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0ZW5Ub1VzZXJSZXNwb25zZRI6Cgp2b2ljZV9pbmZvGAEgASgLMhkuY29uZmEudm9pY2'
    'UudjEuVm9pY2VJbmZvSABSCXZvaWNlSW5mbxI6Cgp2b2ljZV9kYXRhGAIgASgLMhkuY29uZmEu'
    'dm9pY2UudjEuVm9pY2VEYXRhSABSCXZvaWNlRGF0YUIKCghyZXNwb25zZQ==');

@$core.Deprecated('Use watchChannelRequestDescriptor instead')
const WatchChannelRequest$json = {
  '1': 'WatchChannelRequest',
  '2': [
    {'1': 'request_single', '3': 1, '4': 1, '5': 11, '6': '.confa.voice.v1.WatchChannelRequestSingle', '9': 0, '10': 'requestSingle'},
  ],
  '8': [
    {'1': 'request'},
  ],
...
/// Descriptor for `WatchChannelRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List watchChannelRequestDescriptor = $convert.base64Decode(
    'ChNXYXRjaENoYW5uZWxSZXF1ZXN0ElIKDnJlcXVlc3Rfc2luZ2xlGAEgASgLMikuY29uZmEudm'
    '9pY2UudjEuV2F0Y2hDaGFubmVsUmVxdWVzdFNpbmdsZUgAUg1yZXF1ZXN0U2luZ2xlQgkKB3Jl'
    'cXVlc3Q=');

@$core.Deprecated('Use watchChannelRequestSingleDescriptor instead')
const WatchChannelRequestSingle$json = {
  '1': 'WatchChannelRequestSingle',
  '2': [
    {'1': 'server_id', '3': 1, '4': 1, '5': 9, '10': 'serverId'},
    {'1': 'channel_id', '3': 2, '4': 1, '5': 9, '10': 'channelId'},
  ],
...
/// Descriptor for `WatchChannelRequestSingle`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List watchChannelRequestSingleDescriptor = $convert.base64Decode(
    'ChlXYXRjaENoYW5uZWxSZXF1ZXN0U2luZ2xlEhsKCXNlcnZlcl9pZBgBIAEoCVIIc2VydmVySW'
    'QSHQoKY2hhbm5lbF9pZBgCIAEoCVIJY2hhbm5lbElk');

@$core.Deprecated('Use watchChannelResponseDescriptor instead')
const WatchChannelResponse$json = {
  '1': 'WatchChannelResponse',
  '2': [
    {'1': 'server_id', '3': 1, '4': 1, '5': 9, '10': 'serverId'},
    {'1': 'channel_id', '3': 2, '4': 1, '5': 9, '10': 'channelId'},
    {'1': 'users_state', '3': 3, '4': 1, '5': 11, '6': '.confa.voice.v1.UsersState', '10': 'usersState'},
  ],
};

/// Descriptor for `WatchChannelResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List watchChannelResponseDescriptor = $convert.base64Decode(
    'ChRXYXRjaENoYW5uZWxSZXNwb25zZRIbCglzZXJ2ZXJfaWQYASABKAlSCHNlcnZlcklkEh0KCm'
    'NoYW5uZWxfaWQYAiABKAlSCWNoYW5uZWxJZBI7Cgt1c2Vyc19zdGF0ZRgDIAEoCzIaLmNvbmZh'
    'LnZvaWNlLnYxLlVzZXJzU3RhdGVSCnVzZXJzU3RhdGU=');
