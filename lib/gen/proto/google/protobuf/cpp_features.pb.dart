...
class CppFeatures extends $pb.GeneratedMessage {
  factory CppFeatures({
    ...
    if (enumNameUsesStringView != null) result.enumNameUsesStringView = enumNameUsesStringView;
    return result;
  }

  CppFeatures._();

  factory CppFeatures.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory CppFeatures.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
