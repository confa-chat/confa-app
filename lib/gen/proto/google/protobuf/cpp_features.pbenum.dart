...
class CppFeatures_StringType extends $pb.ProtobufEnum {
  ...
  static final $core.List<CppFeatures_StringType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static CppFeatures_StringType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
