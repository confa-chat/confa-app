...
class AuthProvider extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthProvider', package: const $pb.PackageName(_omitMessageNames ? '' : 'konfa.hub.v1'), createEmptyInstance: create)
    ..oo(0, [101])
...
class OpenIDConnect extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OpenIDConnect', package: const $pb.PackageName(_omitMessageNames ? '' : 'konfa.hub.v1'), createEmptyInstance: create)
