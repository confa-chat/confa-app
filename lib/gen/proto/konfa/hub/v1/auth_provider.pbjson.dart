...
const AuthProvider$json = {
  ...
  '2': [
    ...
    {'1': 'openid_connect', '3': 101, '4': 1, '5': 11, '6': '.konfa.hub.v1.OpenIDConnect', '9': 0, '10': 'openidConnect'},
  ],
  '8': [
    {'1': 'protocol'},
  ],
...
final $typed_data.Uint8List authProviderDescriptor = $convert.base64Decode(
    ...
    'BlbmlkX2Nvbm5lY3QYZSABKAsyGy5rb25mYS5odWIudjEuT3BlbklEQ29ubmVjdEgAUg1vcGVu'
